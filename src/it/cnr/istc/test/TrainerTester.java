...
public class TrainerTester {
    ...
    public static void main(String[] args) {
        ...
        float ds = UtilsANN.calculateStandarDeviation(new float[]{3,4,5,9,9});
        
        System.out.println("deviation is: "+UtilsANN.calculateStandarDeviation(new float[]{3,4,5,9,9}));
        System.out.println("deviation is: "+UtilsANN.calculateStandarDeviation(new float[]{6,6,6,6,6}));
        System.out.println("deviation is: "+UtilsANN.calculateStandarDeviation(new float[]{2,4,7,8,9}));
...
//        Trainer.getInstance().train();
        ...
        QuadranteTester qt = new QuadranteTester();
        ...
        frame.setPerceptron(Trainer.getInstance().getPerceptron());
